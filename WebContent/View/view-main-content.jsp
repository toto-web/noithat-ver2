            ...
            <div class="container-fluid">
                        ...
                        <div class="card"> 
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div>
                                        <h5 class="card-title m-b-0">Biểu đồ tương tác</h5>
                                    </div>
                                    <div class="ml-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex m-b-30 no-block">
                                    <h5 class="card-title m-b-0 align-self-center">Nguồn khách hàng tiếp cận</h5>
                                    <div class="ml-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Phản hồi của khách hàng</h5>
                                <ul class="feeds">
                                    <li>
